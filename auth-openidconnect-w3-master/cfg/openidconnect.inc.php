<?php
	...
	$config_openidconnect->client_id = "NDViZDIzY2QtOTU1Ny00";
	$config_openidconnect->client_secret = "NDFlMzIxODMtZTU0YS00";
	$config_openidconnect->redirect_url = "https://localhost:5000/parquet";
?>
